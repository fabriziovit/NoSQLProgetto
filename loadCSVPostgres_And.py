...
csv_files = [
    "traffic_data_And/And_30min_0101_0103_2019.csv",
    "traffic_data_And/And_30min_0506_1610_2021.csv",
    "traffic_data_And/And_30min_1303_0606_2021.csv"
]

def create_traffic_data_and_30min_table(conn):
    cursor = conn.cursor()
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS traffic_data_and_30min (
...
for csv_file in csv_files:
    with open(csv_file, 'r') as file:
        for line in file:
            ...
            insert_query = f"""
                INSERT INTO traffic_data_and_30min (timestamp, road_id, vehicle_count, average_speed)
